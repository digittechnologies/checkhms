...
Route::get('DisplayWard','DisplayController@DisplayWard');
Route::post('Addward','AddController@Addward');
Route::get('DisplayWardType','DisplayController@DisplayWardType');
Route::post('AddWardType','AddController@AddWardType');
...
Route::get('getappcustomer/{id}','DisplayController@getappcustomer');
Route::get('getVoucherStatus/{id}','DisplayController@getVoucherStatus');
...
Route::post('fetchlabForms','DisplayController@fetchlabForms');
