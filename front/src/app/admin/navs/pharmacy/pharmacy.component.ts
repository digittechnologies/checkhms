...
export class PharmacyComponent implements OnInit {
  MessageNotifier:Array<{sender:Number,message:String,receiver:Number}>=[]
  res: any;
  response: any;
  pos: any;
  allPos: any;
  ...
  ngOnInit() {
    ...
    this.Jarwis.profile().subscribe(
      ...
      this.response = data;
      this.id=this.role= this.response.det[0].id
  ...
  // allusers(){
  //   this.chat.user(this.id)
  //   this.chat.unread(this.id)
  //   this.Jarwis.chat().subscribe( 
